...
TEST(DeviceHnsCodecTest, MapsDeviceOpcodes) {
    EXPECT_EQ(NDS_HNS_HW_SQ_OPCODE_FROM_DEVICE(NDS_DEVICE_WR_SEND), NDS_HNS_HW_SQ_SEND);
    EXPECT_EQ(NDS_HNS_HW_SQ_OPCODE_FROM_DEVICE(NDS_DEVICE_WR_RDMA_WRITE), NDS_HNS_HW_SQ_RDMA_WRITE);
    EXPECT_EQ(NDS_HNS_HW_SQ_OPCODE_FROM_DEVICE(NDS_DEVICE_WR_RDMA_READ), NDS_HNS_HW_SQ_RDMA_READ);
    EXPECT_EQ(NDS_HNS_HW_SQ_OPCODE_FROM_DEVICE(99U), NDS_HNS_HW_SQ_INVALID);
}
