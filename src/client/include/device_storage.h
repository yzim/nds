...
static_assert(sizeof(NdsDeviceStorageContext) == 56, "device storage context ABI changed");
static_assert(sizeof(NdsDeviceStorageReadArgs) == 112, "device storage read ABI changed");
static_assert(sizeof(NdsDeviceStorageWriteArgs) == 112, "device storage write ABI changed");
static_assert(sizeof(NdsDeviceStorageBatchReadArgs) == 112, "device storage batch-read ABI changed");
static_assert(sizeof(NdsDeviceStorageBatchWriteArgs) == 112, "device storage batch-write ABI changed");
static_assert(sizeof(NdsDeviceStorageWaitArgs) == 80, "device storage wait ABI changed");
