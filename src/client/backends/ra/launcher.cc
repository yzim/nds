...
Result<void> RaLauncher::post_send_with_config(const LaunchConfig &config, const NdsDeviceQp &qp,
...
Result<void> RaLauncher::post_recv_with_config(const LaunchConfig &, const NdsDeviceQp &qp,
...
Result<std::uint32_t> RaLauncher::poll_cq_with_config(const LaunchConfig &, const NdsDeviceQp &qp, bool send_cq,
                                                      std::uint32_t max_completions, NdsDeviceWc *wc) const {
