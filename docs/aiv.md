...
- AIV kernel: `src/npu_client/modes/aiv/kernel/nds_aiv_roce.cc`, entry point
  `NdsAivRdmaWrite`.
- Host launcher: `src/npu_client/modes/aiv/include/nds/aiv_roce.hh` and
  `src/npu_client/modes/aiv/launcher.cc`.
